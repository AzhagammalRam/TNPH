                ...
                <div className="card-body p-md-5">
                  <div className="row justify-content-center">
                    <div className="col-md-10 col-lg-6 col-xl-8 order-2 order-lg-2">      
                      <p className="text-center h1 text-black fw-bold mt-2">Welcome to TNPH</p>
                      <div id="intro-example" className="p-2 text-center bg-image">
                        <div className="mask">
                          <div className="d-flex justify-content-center align-items-center h-100">
                            <div className="text-black">
                              <Link to="/login-staff" className="btn btn-danger btn-lg m-2 text-white" role="button" rel="nofollow">Login</Link>
                            </div>
                          </div>
                        </div>
                      </div>
