...
function SPCampNav({username,position,activeDashboard,activeProfile,activeTimetable,activeStrength, activeLeave, activeEventsAndCeremonies,activeArchive,children}) {
      ...
      <div className="sidebar pb-3 container-color">
        <nav className="navbar bg-white navbar-dark">
          <div className="row  txt-align-center">
            ...
            <div><Link to="/index-SPCamp" className="navbar-brand mx-4 mb-3">
          ...
          <div className="navbar-nav w-100">
            <Link to="/index-SPCamp" className={`nav-item nav-link ${activeDashboard || defaultClasses}`}><i className="fa fa-tachometer-alt me-2"></i>Dashboard</Link>
            ...
            <Link to="/ArchiveYear" className={`nav-item nav-link ${activeArchive || defaultClasses}`}><i className="fa fa-archive me-2"></i>Archive</Link>
