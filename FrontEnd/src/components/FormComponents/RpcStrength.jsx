    ...
    <div className="container">
      ...
      <div className='col-md-12 row'>
        <div className='col-md-6 d-flex'>
          ...
          <label className='col-md-6'>PTS Vellore</label>
        </div>
        <div className='col-md-6 d-flex'>
      ...
      <Table responsive bordered id="rpc" className='smtbl'>
        <thead>
          <tr>
            ...
            <th className='rotate' rowSpan={2}>RPCs Under Training </th>
            <th colSpan={10}>No of Casuality</th>
            <th className='rotate' rowSpan={3}>Sports OD</th>
            <th className='rotate' rowSpan={2}>Present as on Date</th>
          </tr>
          <tr>
        ...
        <tbody>
            <tr>
              <td className='tblTitle'><label>1</label></td>
                <td><input name="val" placeholder="1"  type="text" /></td>
                <td><input name="val" placeholder="0"  type="text" /></td>
                <td><input name="val" placeholder="3"  type="text" /></td>
                <td><input name="val" placeholder="0"  type="text" /></td>
                <td><input name="val" placeholder="0"  type="text" /></td>
                <td><input name="val" placeholder="0"  type="text" /></td>
                <td><label>4</label></td>  
