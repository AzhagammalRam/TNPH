...
function DSRTimetable() {

    
  // Dummy classes data
  const classesData = [
    { day_of_week: "Monday", module_name: "Practice", start_time: "10:00", end_time: "12:00", lecturer_name: "Sarah Johnson", room_name: "Room 103" },
            ...
            <div className="container-fluid">
                ...
                <div className="col-md-12 mb-3">
                    ...
                    <div className="card-header">
                        <div className='row col-md-12'><div className='col-md-9'><h4 className='title-clr mt-3'><span><i className="bi bi-table me-2"></i></span> Classes  Weekly - Week 1 </h4></div>
