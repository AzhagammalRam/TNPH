...
function ComputerProgrammerNav({username,position,activeDashboard,activeProfile,activeTimetable,activeStrength, activeLeave, activeEventsAndCeremonies,children}) {
      ...
      <div className="sidebar pb-3 container-color">
        <nav className="navbar bg-white navbar-dark">
          <div className="row  txt-align-center">
            ...
            <div><Link to="/index-computerProgrammer" className="navbar-brand mx-4 mb-3">
              <h3 className="text-primary">PTS</h3>
              <h3 className="mb-0 title-clr">Vellore</h3>
            </Link></div>
            {/* <div className="ms-3">
              <h6 className="mb-0 title-clr">Thiruvallur{username}</h6>
              <span>{position}</span>
            </div> */}
          </div>
          <div className="navbar-nav w-100">
            <Link to="/index-computerProgrammer" className={`nav-item nav-link ${activeDashboard || defaultClasses}`}><i className="fa fa-tachometer-alt me-2"></i>Dashboard</Link>
...
export default ComputerProgrammerNav;
